...
### 🟠 GAP-05 — Analytics: CSAT + export now ship; hand-off causes / confidence trends still missing
...
- **Still missing:** hand-off-cause analysis, confidence trends, and first-reply/resolution-time metrics (the hero "1.8s / 00:04.1" numbers remain mock text).
- **Status:** 🟠 Partial (CSAT + export ship; hand-off causes / confidence trends / timing don't) · **Priority:** P1
...
GAP-04 (remaining channels: WhatsApp/Messenger/Instagram/SMS/Slack), GAP-03 (visual workflows), GAP-05 (hand-off causes / confidence trends / timing), GAP-08 (BYO Llama/custom), GAP-09 (SSO/EU), GAP-10 (social proof), GAP-11 (dead CTAs) are **unchanged** and still need either implementation or a "coming soon" relabel.
